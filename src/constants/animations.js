...
export const sphereAnimationDef = {
  ...
  // earth
  10: { scale: 1, rx: 0, ry: Math.PI * 1.1, rz: 0, px: 0, py: -4, pz: -8 },
  13: { scale: 1, rx: 0, ry: Math.PI * 1.1, rz: 0, px: 0, py: -4, pz: -8 },
  ...
  // 1970 telstar
  62: { scale: 0.7, rx: 0 + telstarRotationOffset.x, ry: Math.PI * -2 + telstarRotationOffset.y, rz: 0 +  + telstarRotationOffset.z, px: 0, py: -3, pz: -8 },
  68: { scale: 0.7, rx: 0 + telstarRotationOffset.x, ry: Math.PI * -2 + telstarRotationOffset.y, rz: 0 +  + telstarRotationOffset.z, px: 0, py: -3, pz: -8 },

  72: { scale: 10, rx: 0, ry: 0, rz: 0, px: 0, py: -3, pz: -8 },
  92: { scale: 10, rx: 0, ry: 0, rz: 0, px: 0, py: -3, pz: -8 },

  100: { scale: 0, rx: 0, ry: Math.PI * 2, rz: 0, px: 0, py: 9, pz: -200 }
}
